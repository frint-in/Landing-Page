  ...
  return (
    <div className='PrivacyPolicy'>
      ...
      <div className="globalheader">
        <div className='main-head'>Privacy Policy</div>
        ...
        <ul>
          ...
          <li><b>Company</b> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Frint, Assam Engineering College, AEC Road, Jalukbari, Guwahati- 781013.</li>
          ...
          <li><b>Country</b> refers to: Assam, India</li>
          ...
          <li><b>Service</b> Provider means any natural or legal person who processes the data on behalf of the Company. It refers to third-party companies or individuals employed by the Company to facilitate the Service, to provide the Service on behalf of the Company, to perform services related to the Service or to assist the Company in analyzing how the Service is used.</li>

          <li><b>Third</b>-party Social Media Service refers to any website or any social network website through which a User can log in or create an account to use the Service.</li>
          ...
          <li><b>Website</b> refers to Frint, accessible from <Link to="https://www.frint.in">https://www.frint.in/</Link></li>
        ...
        <ul>
          ...
          <li><b>To provide You with news,</b> special offers and general information about other goods, services and events which we offer that are similar to those that you have already purchased or enquired about unless You have opted not to receive such information.</li>
        ...
        <br /><br />
        <ul>
        <li>By email: <Link to="mailto:office@frint.in">office@frint.in</Link></li></ul>
      </div>
    </div>
  )
}
