...
//         <div className="w-full text-4xl flex items-center justify-center font-bold">Pricing</div>
...
//                       to="/checkout1"
//                       // onClick={<Checkout title="Starter Pack" para1="Dashboard Access" para2="5 internships apply/day" para3="1 resume build" plan="Free for 3 months" money="Free" validity="3 Months" />}
//                     >
//                       Purchase Plan
//                     </Link>
//                   </div>
...
//                       </svg>
//                       <span>3 months Dasboard Access</span>
//                     </li>
//                     <li className="flex items-center">
//                       <svg
//                         className="w-3 h-3 fill-emerald-500 mr-3 shrink-0"
...
//                         <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
//                       </svg>
//                       <span>5 internships apply/day</span>
//                     </li>
//                     <li className="flex items-center">
//                       <svg
//                         className="w-3 h-3 fill-emerald-500 mr-3 shrink-0"
...
//                         <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
//                       </svg>
//                       <span>1 year Dashboard Access</span>
//                     </li>
//                     <li className="flex items-center">
//                       <svg
//                         className="w-3 h-3 fill-emerald-500 mr-3 shrink-0"
...
//                         <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
//                       </svg>
//                       <span>10 internships apply/day</span>
//                     </li>
//                     <li className="flex items-center">
//                       <svg
//                         className="w-3 h-3 fill-emerald-500 mr-3 shrink-0"
...
//                         <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
//                       </svg>
//                       <span>Unlimited internships apply/day</span>
//                     </li>
//                     <li className="flex items-center">
//                       <svg
//                         className="w-3 h-3 fill-emerald-500 mr-3 shrink-0"
