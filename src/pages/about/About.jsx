    ...
    <div className="About">
      <div className="about-us">
        ...
        <div className="services">
          <h1>Our Services</h1>
          <p>Bringing talent together, empowering career and shaping the future of work</p>    
          <div className="card-container">
            <div className="card">
              <img src="freelance.png" alt="" />
              <h2>Internship</h2>
              <p>Discover a curated selection of top-notch internships in various fields</p>
            </div>
            <div className="card">
              <img src="intership.png" alt="" />
              <h2>Freelancing</h2>
              <p>Earn extra income and build your skills wiht flexible and remote freelance projects</p>
            </div>
            <div className="card">
              <img src="skill.png" alt="" />
              <h2>Skill Development</h2>
              <p>Improve your skills and stay up to date with the latest industry trends through online courses and training programs</p>
            </div>
          </div>            
        </div>
